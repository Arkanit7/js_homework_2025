...
const randomNumbers = createRandomNumbersArray(7, -21, 21)
const sumOddNumbersLess11 = randomNumbers.reduce(
  (sum, item) => (item % 2 && item < 11 ? sum + item : sum),
  0,
)

document.write(`<p>Масив: [${randomNumbers.join(', ')}]</p>`)
document.write(`<p>Сума: ${sumOddNumbersLess11}`)
